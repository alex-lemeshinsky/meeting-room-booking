...
import { parseSeedNowOverride, resolveSeedNow } from "./seed-clock.js";
...
const seedNowOverride = parseSeedNowOverride(process.env.MRB_SEED_NOW);
...
async function seed(): Promise<void> {
  ...
  const seedNow = resolveSeedNow(seedNowOverride);
