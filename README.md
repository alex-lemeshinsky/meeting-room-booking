...
захист авторизованих маршрутів, список переговорних кімнат, тижневий розклад і
створення одноразового бронювання з вільного календарного слота. Календар
показує сім локальних днів, бронювання поточного тижня, власника, часовий пояс,
порожні тижні та помилки завантаження; на mobile решта днів доступна
контрольованим горизонтальним scroll, а форма відкривається на весь екран.
...
email, фільтрація кімнат за місткістю, скасування бронювань, повторення та
сповіщення залишаються для наступних слайсів.
